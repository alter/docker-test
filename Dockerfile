...
RUN DEBIAN_FRONTEND=noninteractive apt-get update && DEBIAN_FRONTEND=noninteractive apt-get install gdebi wget aptitude libxslt1.1 -y && mkdir -p /var/www/html && rm -f /etc/nginx/sites-enabled/default
